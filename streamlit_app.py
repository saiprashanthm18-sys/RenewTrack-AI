...
if page == "📊 Dashboard Overview":
    ...
    st.image(IMAGES["hero"], use_container_width=True, caption="Optimizing National Grid Resilience")
...
# --- PAGE 2: UTILIZATION ANALYSIS ---
    ...
    st.image(IMAGES["utilization"], use_container_width=True)
...
# --- PAGE 5: AI RECOMMENDATION ENGINE ---
    ...
    st.image(IMAGES["recommendation"], use_container_width=True)
...
# --- PAGE 6: INDIA HEATMAP ---
    ...
    st.image(IMAGES["map"], use_container_width=True)
...
# --- PAGE 7: SCENARIO SIMULATOR ---
    ...
    st.image(IMAGES["solar"], use_container_width=True)
